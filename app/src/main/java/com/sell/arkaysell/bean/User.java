...
public class User {
    ...
    public User(String userID, String email, String profileImage, String userDisplayName) {
        this.userID = userID;
        this.email = email;
    ...
    public User(String userID, String email, String profileImage, String userDisplayName, String actualPic, String actualName, String countryCode, String country, String city, String countyFlagURL, boolean isAdsRemove) {
        this.userID = userID;
        this.email = email;
        this.profileImage = profileImage;
        this.userDisplayName = userDisplayName;
