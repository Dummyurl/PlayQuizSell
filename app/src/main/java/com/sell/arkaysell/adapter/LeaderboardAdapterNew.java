...
public class LeaderboardAdapterNew extends BaseAdapter {
    ...
    private Typeface tp;
    private TextView txtName, txtScore, txtStar, txtRank;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //settings = activity.getSharedPreferences(Constants.PREFS_NAME, 0);
       ...
       // txtStar.setText(""+leaderboards.get(position).getName());


        txtScore.setTypeface(tp);
        txtName.setTypeface(tp);
      //  txtStar.setTypeface(tp);
