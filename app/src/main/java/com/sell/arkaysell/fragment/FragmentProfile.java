...
public class FragmentProfile extends Fragment implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private TextView txtGames, txtScore, txt, txt1, txt2, txt3, txtUname, txtEmailID, txtStarts;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
       ...
       // txt2 = (TextView) view.findViewById(R.id.txt2);
        ...
        //String uid = settings.getString(HomeScreenActivity.USER_ID, "");
       ...
       // txtStarts = (TextView) view.findViewById(R.id.txtStarts);
        ...
        if (url != null) {
            if (!url.isEmpty()) {
                ...
                //circularImageView.setImageDrawable(getResources().getDrawable(R.drawable.pr));
            }
        } else {
            //circularImageView.setImageDrawable(getResources().getDrawable(R.drawable.profile_picture));
        }
